...
crDecimal: "5"
template: "creature"
path: "/bestiary/gnoll-king-hogger"
---
...
> ___
>
> - **Skills** Athletics +7, Survival +5, Intimidation +7
...
> ### Reactions
>
> ***Headbutt.*** Hogger headbutts a creature within reach that missed him with an attack. The creature must succeed on a DC 13 Constitution saving throw or be stunned until the end of Hogger's next turn. To do so, Hogger must see the attacker.
>
> ### Legendary Actions
> Hogger can take 2 legendary actions, choosing from the options below. Only one legendary action option can be used at a time and only at the end of another creature's turn. Hogger regains spent legendary actions at the start of his turn.
>
> **Attack.** Hogger makes one melee weapon attack.
> <br> **Move.** Hogger move up to half his speed.
> <br> **Kill Command (Costs 2 Actions).** Hogger uses Kill <br>&nbsp;&nbsp;&nbsp; Command.
