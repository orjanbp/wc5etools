...
>
> ***Acid Spit.*** *Ranged Weapon Attack:* +4 to hit, range 15/30 ft., one creature. *Hit:* 6 (1d8 + 2) acid damage. At the end of each of its turns, the creature must make a DC 10 Constitution saving throw, taking 2 (1d4) acid damage on a failure or ending the recurring acid damage on a success.
